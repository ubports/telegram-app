...
Item {
    ...
    //signal clicked() // Hack to allow getting click event and allow ListItem drag
...
//                        visible: !msg_media.hasMedia && !uploading || msg_media.isAudioMessage
                        ...
                        TextEdit {
                            ...
                            text: msg_media.mediaPlayer // msg_media.isAudioMessage
                                // TRANSLATORS: Default message for received audio messages.
                                 ? i18n.tr("Audio messages not supported yet.")
                                 : emojis.bodyTextToEmojiText(messageText)
                            ...
                            property string messageText: encryptMedia ? i18n.tr("Media files are currently not supported in secret chats.") : message.message
                        }
                    }

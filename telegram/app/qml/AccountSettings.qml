        ...
        ListItem {
            ...
            ListItemLayout {
                ...
                Switch {
                    ...
                    SlotsLayout.position: SlotsLayout.Last
                    onCheckedChanged: mainView.theme.name = mainView.theme.name == "Ubuntu.Components.Themes.SuruDark" ? "Ubuntu.Components.Themes.Ambiance" : "Ubuntu.Components.Themes.SuruDark"
                }
            }
        }
